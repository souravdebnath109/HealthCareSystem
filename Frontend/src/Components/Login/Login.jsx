      ...
      >
        ...
        <div className="form-container sign-up-container">
          <form onSubmit={handleRegisterSubmit}>
            ...
            {/* Optional fields for better checkout experience */}
            <input
              type="text"
              name="full_name"
            ...
            <small style={{ fontSize: "12px", color: "#666", marginBottom: "10px" }}>
              Fill optional fields now to skip them at checkout
            </small>
        ...
        <div className="form-container sign-in-container">
          <form onSubmit={handleLoginSubmit}>
            ...
            <Link to="/loginadmin" className="ghost">Are you an admin?</Link>
            <Link to="/doctorlogin" className="ghost">Are you a doctor?</Link>
            <Link to="/forget_password" className="ghost">Forget Password?</Link>
          </form>
        </div>
