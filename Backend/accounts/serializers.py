...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomUser
        fields = ['id', 'username', 'email', 'full_name', 'phone_number', 'address', 'profile_image']
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id', 'username', 'email', 'password1', 'password2', 'full_name', 'phone_number', 'address']
...
class UserUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['username', 'email', 'password', 'profile_image', 'full_name', 'phone_number', 'address', 'old_email', 'old_password']
        extra_kwargs = {
            'password': {'write_only': True, 'required': False},
            'email': {'required': False},
            'username': {'required': False},
    ...
    def validate(self, data):
        ...
        # user = authenticate(email=old_email, password=old_password)
        user = authenticate(username=old_email, password=old_password)
